...
peer lifecycle chaincode commit -o orderer0.example.com:7050 --init-required --channelID $CHANNEL_NAME --name marbles02 --version 1.0 --sequence 1  --tls true --cafile $ORDERER_CA --peerAddresses peer0.ecoFarm.example.com:7051 --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE  --peerAddresses peer0.logisticTrans.example.com:8051 --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE2 
